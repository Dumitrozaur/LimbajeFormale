def moore_traffic_light():
    ...
    while True:
        ...
        # Aplicarea tranziției
        if (current_state, (A, B)) in transitions:
            next_state = transitions[(current_state, (A, B))]
            print(f"Stare curentă: {current_state}, Intrare: ({A}, {B}) -> Stare următoare: {next_state}, Ieșire: {outputs[next_state]}")
